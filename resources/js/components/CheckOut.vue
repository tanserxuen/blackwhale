...
export default{
    ...
    methods:{
        ...
        checkForm(){
            ...
            if(this.customer.name && this.customer.contact && this.customer.pickup_time && this.outlet)
                this.addCustomer();
            ...
            console.log(JSON.stringify(this.customer.pickup_time));
        ...
        removeCart(id){
            ...
            window.open(`http://blackwhale.my/pdf`, "_blank");
        ...
        getNow() {
            ...
            this.date = date+"T"+today.getHours() + ":" + today.getMinutes();
            this.time = time;
        }
    }
}
