            ...
            <div class="grid-container">
                <div>
                    ...
                    <div style="max-width: 340px; padding: 10px">
                        ...
                        <img src="/storage/img/{{$teaserie->image}}" alt="{{$teaserie->name}}"  width="150px" height="150px"><br><br>
                    </div>
                ...
                <div class="pl-4">
                    ...
                    <div>
                        <h4>Price</h4>
                        <p style="width: 600px; height:50px;">RM {{number_format($teaserie->price, 2)}}</p> 
                    </div>
                    <div>
                        <h4>Rating</h4>
